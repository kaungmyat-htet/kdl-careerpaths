...
"""
kdl-careerpaths documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'kdl-careerpaths',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/night-owls-vms/kdl-careerpaths",
...
#
# html_title = 'kdl-careerpaths v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Career Path Management App for KDL.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'kdl_careerpaths'),
                os.path.join(root_path, 'kdl_careerpaths/migrations')])
