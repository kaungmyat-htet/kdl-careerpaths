#!/usr/bin/env python
"""
Package metadata for kdl_careerpaths.
"""
import os
import re
import sys
...
VERSION = get_version('kdl_careerpaths', '__init__.py')
...
setup(
    name='kdl-careerpaths',
    version=VERSION,
    description="""Career Path Management App for KDL.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='KDL Project',
    author_email='kaungmyathtet.dev@gmail.com',
    url='https://github.com/night-owls-vms/kdl-careerpaths',
